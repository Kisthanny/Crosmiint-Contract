...
describe("NFTMarketplace", () => {
    ...
    beforeEach(async () => {
        ...
        collection721 = await Collection721Factory.connect(owner).deploy("Collection721", "C721", "", GATEWAY, true) as Collection721 & {
            deploymentTransaction(): ContractTransactionResponse;
            getAddress(): Promise<string>;
        };
        ...
        collection1155 = await Collection1155Factory.connect(owner).deploy("Collection1155", "C1155", "", GATEWAY, true) as Collection1155 & {
            deploymentTransaction(): ContractTransactionResponse;
            getAddress(): Promise<string>;
        };
